...
#define BG_COLOR 1.0, 0.0, 0.0
#define BG_ALPHA 1.0
#define DRAW_COLOR 1.0, 1.0, 0.0

#define WIN_BREADTH 1366
#define WIN_HEIGHT 1080
#define WIN_POSITION_X 0
#define WIN_POSITION_Y  0
#define WIN_DIM_NEG_X -100
#define WIN_DIM_POS_X 100
#define WIN_DIM_NEG_Y -100
